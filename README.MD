...
[Exercise 2.5](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/2.5) 
[Exercise 2.6](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/2.6) 
[Exercise 2.7](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/2.7) 
[Exercise 2.8](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/2.8) 
[Exercise 2.9](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/2.9) 
[Exercise 2.10](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/2.10) 

## Chapter 4

[Exercise 3.1](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.1) 
[Exercise 3.2](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.2) 
[Exercise 3.3](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.3) 
[Exercise 3.4](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.4) 
[Exercise 3.5](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.5) 
[Exercise 3.6](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.6) 
[Exercise 3.7](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.7) 
[Exercise 3.8](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.8) 
[Exercise 3.9](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.9) 
[Exercise 3.10](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.10) 
[Exercise 3.11](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.11) 
[Exercise 3.12](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/3.12) 

## Chapter 5

[Exercise 4.1](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/4.1) 
[Exercise 4.2](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/4.2) 
[Exercise 4.3](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/4.3) 
[Exercise 4.4](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/4.4) 
[Exercise 4.5](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/4.5) 
[Exercise 4.6](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/4.6) 
[Exercise 4.7](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/4.7) 
[Exercise 4.8](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/4.8) 
[Exercise 4.9](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/4.9) 
[Exercise 4.10](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/4.10) 


## Chapter 6
[Exercise 5.1](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/5.1) 
[Exercise 5.2](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/5.2) 
[Exercise 5.3](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/5.3) 
[Exercise 5.4](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/5.4) 
[Exercise 5.6](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/5.6) 
[Exercise 5.7](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/5.7) 
[Exercise 5.8](https://github.com/andreasZel/devops_with_kubernetes_mooc_fi/tree/5.8) 


# Instructions for Exercise 5.2

I followed the [documentation](https://istio.io/latest/docs/setup/install/helm/) to install with HELM.
If we also read [how to deploy example app](https://istio.io/latest/docs/examples/bookinfo/#before-you-begin), we need to
have `at least 4 standard GKE nodes` if we use **GKE**, which I used.

So we create a cluster with the requirements:
...
# install in istio-system namespace
...
To deploy the app we follow the steps:
...
we add a geteway api to be able to access the app:

first enable it in our cluster, as we done previously:

```bash
gcloud container clusters update dwk-cluster --location=europe-west1-b --gateway-api=standard
```

then add the gateway api:
...
then we can access the `GATEWAY_URL/productpage`

To unistall we can use the guides [here](https://istio.io/latest/docs/examples/bookinfo/#before-you-begin) and [here](https://istio.io/latest/docs/setup/install/helm/)
...
First we create a cluster with **traefik disabled**:

```bash
$ k3d cluster create --port 8082:30080@agent:0 -p 8081:80@loadbalancer --agents 2 --k3s-arg "--disable=traefik@server:0"
```

then we install cert-manager CRDs and components:
...
then Install **Kourier networking** and **configure knative to use it**:
...
finally, **Configure Magic DNS (sslip.io)**:
...
Then we can apply a basic hello world app, by creating a .yaml and applying it:

```yaml
# hello-world-example.yaml file
...
we can then test if it is working with, getting the URL and executing 
...
hello   http://hello.default.sslip.io   hello-00001     hello-00001   True

# execute command
curl -H "Host: hello.default.sslip.io" http://localhost:8081
```

# Exercise 5.8 CNCF Cloud Native Landscape

I only added a map for every product / project used in this module.
- ${{\color{red} \ red}}$ are the ones used ${{\color{red} \ directly}}$
- ${{\color{green} \ green}}$ are the ones used ${{\color{green} \ in-directly}}$

The map is as follows:

![CNCF Map](./assets/landscape.png)

## Directly Used / Explicitly Invoked

- Kubernetes

  Used in every repo (MOOC exercises, Log Output, Project Server, Wikipedia App, DummySite) to deploy workloads via manifests (kubectl apply). Managed Deployments, Services, StatefulSets, PVCs, Ingress.

- k3s / k3d (with Docker)

  Local lightweight Kubernetes clusters for testing/development in all repos. Runs workloads, provides local cluster environment for MOOC exercises, Project Server, Wikipedia App, DummySite.

- Helm

  Used to install Istio, Prometheus, Kiali, Knative, and other Helm chart‑based components in MOOC exercises and Project Server.

- Argo CD

  GitOps tool for Project Server deployment; manages live manifests from GitHub repository.

- PostgreSQL

  Deployed as a StatefulSet with PVCs in Project Server, Project Server Config. Provides persistent storage.

- Knative (Serverless)

  Installed via manifests/Helm in MOOC exercises and Project Server for serverless app deployment. Kourier used as networking layer.

- Istio

  Installed via Helm in MOOC exercises and Log Output for service mesh. Handles traffic routing, observability (Envoy sidecars).

- SOPS

  Used in Project Server / Project Server Configuration for secrets encryption.

- Prometheus

  Installed alongside Istio for monitoring and metrics collection (MOOC exercises / Log Output / Project Server).

- Kiali

  Installed for Istio observability; visualizes service mesh traffic (MOOC exercises / Log Output).

- Grafana

  Visualizes Prometheus metrics (MOOC exercises / Project Server).

- Grafana Loki

  Centralized logging backend, integrates with Grafana dashboards (MOOC exercises / Project Server).

- GitHub Actions

  Project Server workflows automate CI/CD (build Docker image, push to registry, deploy to k3d/k3s or GKE).

- Google Cloud / GKE (Free Trial)

  Deployed Kubernetes workloads on GKE cluster. Also Artifact Registry that stores container images and Cloud Storage Bucket that stores persistent data or artifacts.

- Kourier

  Knative networking layer used for serverless workloads in MOOC exercises / Project Server.

- Cert-manager

  Manages TLS certificates for Knative and Ingress endpoints in MOOC exercises / Project Server.

## Indirect / Under-the-Hood Dependencies

- Docker

  Underlying engine for k3d/k3s clusters. Builds container images for Project Server, Wikipedia App, DummySite.

- Containerd

  Container runtime inside k3s/k3d clusters.

- CoreDNS

  Cluster DNS service in k3s/k3d; resolves service names for all pods/workloads.

- CNI Plugins (Flannel / Calico / default)

  Provides Kubernetes cluster networking.

- etcd

  Kubernetes internal key-value store that maintains cluster state.

- Envoy

  Service mesh data-plane proxy used by Istio sidecars for routing.

- NGINX

  Optional ingress controller in MOOC exercises or local k3s/k3d clusters.

- Traefik

  Alternative ingress controller that may be used by default in k3s clusters.
...
#### ⚠️ Cannot access cluster problem 

Because docker uses `docker.internal` as the URL of the cluster, we have to change it to localhost [127.0.0.1] in `kubeconfig` file. 
...
Kubernetes by default takes down the previous pods and replaces them with the new ones. This strategy is called `Recreate`.
...
Until now we are using the **push release method**, where:

1. Developer pushes modified code to a repository, such as GitHub.
2. This triggers a CI/CD service, like GitHub Actions, to start running.
3. The CI/CD service runs tests, builds an image, pushes the image to a registry, and deploys the new image, for example, to Kubernetes.

There are some challenges with the push approach. For example, if we have a Kubernetes cluster that is unavailable for external connections i.e. the cluster on your local machine or any cluster we don't want to give outsiders access to. In those cases having CI/CD push the update to the cluster is not possible.

`GitOps` is all about reversal, meaning we can have **the cluster, running anywhere**, *pull the new image* and deploy it automatically.
The new image will still be tested and built by the CI/CD. We simply relieve the CI/CD of the burden of deployment and move it to another system that is doing the pulling.

It promotes good practices for the operations side of things. This is achieved by maintaining the state of the cluster in a Git repository, thereby handling not only application deployments but also all changes to the cluster.

> We also used a similar approach in Docker with `watchtower` which enabled us to change the last pushes of a deployment pipeline to pulls when running services with docker-compose.

The current state of the art tool for Kubernetes GitOps is `ArgoCd`.

We can add it to the cluster with:
...
we also need to expose it to access the UI:

```bash
kubectl patch svc argocd-server -n argocd -p '{"spec": {"type": "LoadBalancer"}}'
```

we can find the password for the username `admin` by:

```bash
kubectl get -n argocd secrets argocd-initial-admin-secret -o yaml
```

and `decode` the base64 encoded password we get.

we then create a new project and **add the git repo**, choose `manual sync policy`. The destination cluster should be 
alresdy configured so we add the one suggested.

After we see that our app is running, we can create our `github workflow`, this can just update the images ny pushing them and
use `kustomize edit` to set them in our `kustomization.yml`.

A workoflow would look like so:
...
env:
  ...
  #image names
  RANDOM_STRING: zelhs/ping-pong-application
  PING_PONG: zelhs/randomstring
...
jobs:
  build-publish:
    ...
    steps:
      ...
      - name: 'Form image names'
        run: |
          echo "IMAGE_TAG_RANDOM_STRING=$REGISTRY/$PROJECT_ID/$REPOSITORY/$RANDOM_STRING:$BRANCH-$GITHUB_SHA" >> $GITHUB_ENV
          echo "IMAGE_TAG_PING_PONG=$REGISTRY/$PROJECT_ID/$REPOSITORY/$PING_PONG:$BRANCH-$GITHUB_SHA" >> $GITHUB_ENV
...
in this one we upload images to artifact registry, update the kustomization and commit the changes to github.
This can be altered to be dockerhub.

#### Multiple Environments

When Kustomize is used, the recommended way is to define a `common base` for all the environments and then environment `specific overlays` where the differing parts are defined.

1. We define a `base` folder containing essential .yml files and kustomize.

2. We define `overlays`, basically other .yml files that `patch` the existing ones and kustomize.

A basic structure would be as follows:
...
then in `overlays/prod/deployment.yaml` we might change the replica number to 3:
...
and `patch` in the kustomize `overlays/prod/kustomization.yaml`:
...
here we patched a resource, but this also applies to images.

#### Defining ArgoCd with a Resource

We can use `Application Custom resource definition` instead of ArgoCd UI. It can be defined
as follows:
...
spec:
  ...
  syncPolicy:
    automated:
      prune: <strong>true</strong>
      selfHeal: <strong>true</strong>
```

this is the declerative approach using a yml file. We could also work using the
[cli tool](https://argo-cd.readthedocs.io/en/stable/getting_started/#2-download-argo-cd-cli).
...
According to ArgoCD the `best method` is to keep source code and configurations on `a seperate repo`.